  ...
  return (
    <div className="py-12 md:py-16">
      ...
      <section className="max-w-3xl mx-auto px-4 mb-12 md:mb-16">
        <h2 className="text-2xl md:text-3xl font-semibold text-center mb-10 font-title text-[var(--text-on-dark)]">Proceso del Servicio</h2>
        <div className="space-y-8">
            <div className="flex items-start"><StepProcessIcon number={1} /><p className="text-[var(--text-on-dark-soft)]/85 pt-1">Compila y envíanos toda la información detallada y documentos relevantes de tu caso a través de un formulario seguro.</p></div>
            <div className="flex items-start"><StepProcessIcon number={2} /><p className="text-[var(--text-on-dark-soft)]/85 pt-1">Nuestra IA especializada analiza los datos, contrastándolos con jurisprudencia, legislación vigente y casos similares.</p></div>
            <div className="flex items-start"><StepProcessIcon number={3} /><p className="text-[var(--text-on-dark-soft)]/85 pt-1">Un abogado especialista de Ciberabogados revisa, valida y enriquece el análisis de la IA con su criterio experto.</p></div>
            <div className="flex items-start"><StepProcessIcon number={4} /><p className="text-[var(--text-on-dark-soft)]/85 pt-1">Recibes un informe completo en PDF con el análisis de hechos, escenarios posibles, riesgos, fortalezas y recomendaciones estratégicas.</p></div>
        </div>
      </section>

      <section className="max-w-4xl mx-auto px-4 mb-12 md:mb-16">
        <h2 className="text-2xl md:text-3xl font-semibold text-center mb-10 font-title text-[var(--text-on-dark)]">Visualiza tu Reporte (Ejemplo)</h2>
        <Card className="p-6 bg-[var(--surface-subtle)]/50 border-2 border-[var(--border-subtle)]/30">
            <h3 className="text-xl font-semibold text-[var(--sky-blue-light)] font-title mb-3">Secciones Clave del Informe:</h3>
            <ul className="list-disc list-inside text-[var(--text-on-dark-soft)]/85 space-y-2 pl-4 text-sm">
            ...
            <p className="text-xs text-center mt-4 text-[var(--text-on-dark-soft)]/60">(Este es un ejemplo de la estructura. El contenido real será específico a tu caso.)</p>
        </Card>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-4 mb-12 md:mb-16 text-center">
        ...
        <h2 className="text-2xl md:text-3xl font-semibold mb-4 font-title text-[var(--text-on-dark)]">¿Por Qué la Validación de un Experto?</h2>
        <p className="text-[var(--text-on-dark-soft)]/85 leading-relaxed mb-6">
      ...
      <section className="max-w-3xl mx-auto px-4 mb-12 md:mb-16">
         <Card className="p-6 md:p-8 text-center bg-gradient-to-r from-[var(--surface-subtle)] to-[var(--deep-blue-dark)] border border-[var(--border-subtle)]/50">
            ...
            <h3 className="text-xl font-semibold text-[var(--sky-blue-light)] font-title mb-2">Tiempo de Entrega Estándar</h3>
            <p className="text-2xl font-bold text-[var(--text-on-dark)] mb-3">48 Horas Hábiles</p>
            <p className="text-sm text-[var(--text-on-dark-soft)]/80">
      ...
      <section className="text-center px-4 mb-12 md:mb-16">
        <Card className="max-w-2xl mx-auto p-8">
            <h3 className="text-xl md:text-2xl font-semibold text-[var(--sky-blue-light)] font-title mb-3">¿Necesitas Ayuda para Implementar las Recomendaciones?</h3>
